class SchoolDivisionWardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @school_division_ward.save
        format.html do
          redirect_to school_division_ward_url(@school_division_ward),
                      notice: "School division ward was successfully created."
        end
  ...
  def update
    respond_to do |format|
      if @school_division_ward.update(school_division_ward_params)
        format.html do
          redirect_to school_division_ward_url(@school_division_ward),
                      notice: "School division ward was successfully updated."
        end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
        redirect_to school_division_wards_url,
                    notice: "School division ward was successfully destroyed."
      end
